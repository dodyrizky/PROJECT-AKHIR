    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          {{-- Anak --}}
          <li class="nav-item">
            <a href="{{ route('Data_Anak.index') }}" class="nav-link">
          ...
          {{-- sekolah --}}
          {{-- <li class="nav-item">
            <a href="{{ route('Data_Sekolah.index') }}" class="nav-link">
          ...
          {{-- Donasi --}}
          <li class="nav-item">
            <a href="{{ route('Data_Donasi.index') }}" class="nav-link">
          ...
          {{-- akhir catatan keuangan --}}

          {{-- Kegiatan --}}
          <li class="nav-item">
            <a href="{{route('Data_Kegiatan.index')}}" class="nav-link">
