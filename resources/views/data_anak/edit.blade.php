        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('Data_Anak.update', $data->id) }}" method="POST">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="nama" id="nama" autofocus class="form-control" value="{{ $data->nama }}">
                            @error('nama')
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="NIK" id="NIK" autofocus class="form-control" value="{{ $data->NIK}}">
                            @error('NIK')
                                <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div> 
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="no_kk" id="no_kk" autofocus class="form-control" value="{{ $data->no_kk}}">
                            @error('no_kk')
                                <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div> 
                        ...
                        <div class="form-group mb-2">
                            ...
                            <select name="jenis_kelamin" id="dropdown">
                                <option value=""></option>
                                @foreach ( $jk as $row )
                                <option @if($data->jenis_kelamin == $row->JenisKelamin) selected @endif value="{{$row->JenisKelamin}}">{{$row->JenisKelamin}}</option>
                                @endforeach
                            </select>
                            @error('jenis_kelamin')
                                <small class="text-danger">{{$message}}</small>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <select name="status_anak" id="dropdown2">
                                ...
                                @foreach ($status_anak as $row)
                                    <option @if($data->status_anak == $row->status_anak) selected @endif value="{{$row->status_anak}}">{{$row->status_anak}}</option>
                                @endforeach
                            </select>
                            @error('status_anak')
                                <small class="text-danger">{{$message}}</small>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <select name="hubungan_dalam_keluarga" id="dropdown3">
                                ...
                                @foreach ($hubungan_anak as $row)
                                    <option @if($data->hubungan_dalam_keluarga == $row->hubungan_anak) selected @endif value="{{$row->hubungan_anak}}">{{$row->hubungan_anak}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="asal_desa" class="form-control" value="{{ $data->asal_desa}}">
                            @error('asal_desa')
                                <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div> 
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="tahun_keluar_panti" class="form-control" value="{{ $data->tahun_keluar_panti}}">
